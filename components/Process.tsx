  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        title="Development & Launch" icon={<AceternityIcon order="Phase 3" />}>
          <CanvasRevealEffect
            animationSpeed={3}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-1/2 left-1/2 group-hover/canvas-card:opacity-0 transition duration-200 w-full -translate-x-1/2 -translate-y-1/2 mx-auto flex items-center justify-center ">
          {icon}
        </div>
